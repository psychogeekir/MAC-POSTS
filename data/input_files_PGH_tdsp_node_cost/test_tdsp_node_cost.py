...
tdsp_api.initialize(folder, max_interval, num_rows_link_file, num_rows_node_file, link_tt_file_name, node_tt_file_name, link_cost_file_name, node_cost_file_name)
