...
data_folder_observed = os.path.join('/home/qiling/Documents/MAC-POSTS/data/input_files_16link_multimodal')
data_folder = data_folder_observed
...
if os.path.isfile(os.path.join(data_folder_observed, 'true_16link_pathflow.pickle')) and not override:
    ...
    true_f_truck_driving = np.random.rand(
        num_interval * nb.config.config_dict['FIXED']['num_driving_path']) * 50
    ...
    #     true_passenger_dar_matrix_bustransit, true_passenger_dar_matrix_pnr, passenger_bus_link_flow_relationship = \
    #     dode.get_dar(dta, true_f_car_driving, true_f_truck_driving,
    #                 true_f_passenger_bustransit, true_f_car_pnr, true_f_bus)
...
# %% first based on count, then add tt
max_epoch = 50

column_generation = np.zeros(max_epoch, dtype=bool)
# column_generation[:3] = 1
...
link_bus_flow_weight = np.ones(max_epoch, dtype=float) * 0 # * 0
...
# car_driving_step_size = np.ones(max_epoch) * 5
# # car_driving_step_size[50:] = 0 
# truck_driving_step_size = np.ones(max_epoch) * 1
# # truck_driving_step_size[50:] = 0 
# passenger_bustransit_step_size = np.ones(max_epoch) * 1
# # passenger_bustransit_step_size[30:] = 1
# car_pnr_step_size = np.ones(max_epoch) * 1
...
#                             car_driving_step_size=car_driving_step_size, truck_driving_step_size=truck_driving_step_size, 
#                             passenger_bustransit_step_size=passenger_bustransit_step_size, car_pnr_step_size=car_pnr_step_size,
#                             link_car_flow_weight=link_car_flow_weight, link_truck_flow_weight=link_truck_flow_weight, link_passenger_flow_weight=link_passenger_flow_weight, link_bus_flow_weight=link_bus_flow_weight,
#                             link_car_tt_weight=link_car_tt_weight, link_truck_tt_weight=link_truck_tt_weight, link_passenger_tt_weight=link_passenger_tt_weight, link_bus_tt_weight=link_bus_tt_weight,   
...
f_car_driving, f_truck_driving, f_passenger_bustransit, f_car_pnr, f_bus, \
    x_e_car, x_e_truck, x_e_passenger, x_e_bus, tt_e_car, tt_e_truck, tt_e_passenger, tt_e_bus, loss_list = \
    dode.estimate_path_flow_pytorch2(car_driving_scale=10, truck_driving_scale=2, passenger_bustransit_scale=2, car_pnr_scale=2, bus_scale=None,
                                    car_driving_step_size=2, truck_driving_step_size=0.6, passenger_bustransit_step_size=1, car_pnr_step_size=1, bus_step_size=None,
                                    link_car_flow_weight=link_car_flow_weight, link_truck_flow_weight=link_truck_flow_weight, link_passenger_flow_weight=link_passenger_flow_weight, link_bus_flow_weight=link_bus_flow_weight,
                                    link_car_tt_weight=link_car_tt_weight, link_truck_tt_weight=link_truck_tt_weight, link_passenger_tt_weight=link_passenger_tt_weight, link_bus_tt_weight=link_bus_tt_weight,
                                    max_epoch=max_epoch, algo="Adamax", run_mmdta_adaptive=False, fix_bus=True, column_generation=column_generation, use_tdsp=True,
                                    use_file_as_init=None, 
                                    save_folder=os.path.join(data_folder, 'record'), starting_epoch=0)

# f_car_driving, f_truck_driving, f_passenger_bustransit, f_car_pnr, f_bus, \
#     x_e_car, x_e_truck, x_e_passenger, x_e_bus, tt_e_car, tt_e_truck, tt_e_passenger, tt_e_bus, loss_list = \
#     dode.estimate_path_flow_pytorch2(car_driving_scale=10, truck_driving_scale=1, passenger_bustransit_scale=2, car_pnr_scale=1, bus_scale=None,
#                                     car_driving_step_size=0, truck_driving_step_size=0.2, passenger_bustransit_step_size=1, car_pnr_step_size=0.2, bus_step_size=None,
#                                     link_car_flow_weight=link_car_flow_weight, link_truck_flow_weight=link_truck_flow_weight, link_passenger_flow_weight=link_passenger_flow_weight, link_bus_flow_weight=link_bus_flow_weight,
#                                     link_car_tt_weight=link_car_tt_weight, link_truck_tt_weight=link_truck_tt_weight, link_passenger_tt_weight=link_passenger_tt_weight, link_bus_tt_weight=link_bus_tt_weight,
#                                     max_epoch=max_epoch, algo="NAdam", fix_bus=True, column_generation=column_generation, use_tdsp=False,
...
#                                     car_driving_step_size=0.5, truck_driving_step_size=0.1, passenger_bustransit_step_size=0.2, car_pnr_step_size=0.05, bus_step_size=None,
#                                     link_car_flow_weight=link_car_flow_weight, link_truck_flow_weight=link_truck_flow_weight, link_passenger_flow_weight=link_passenger_flow_weight, link_bus_flow_weight=link_bus_flow_weight,
#                                     link_car_tt_weight=link_car_tt_weight, link_truck_tt_weight=link_truck_tt_weight, link_passenger_tt_weight=link_passenger_tt_weight, link_bus_tt_weight=link_bus_tt_weight,
#                                     max_epoch=max_epoch, algo="NAdam", l2_coeff=0, fix_bus=True, column_generation=column_generation, use_tdsp=False,
#                                     use_file_as_init=None, save_folder=os.path.join(data_folder, 'record'), starting_epoch=0)
...
#     x_e_car, x_e_truck, x_e_passenger, x_e_bus, tt_e_car, tt_e_truck, tt_e_passenger, tt_e_bus, loss_list = \
#     dode.estimate_path_flow_pytorch(car_driving_scale=1, truck_driving_scale=1, passenger_bustransit_scale=1, car_pnr_scale=1, bus_scale=None,
#                                     car_driving_step_size=0.5, truck_driving_step_size=0.2, passenger_bustransit_step_size=0.2, car_pnr_step_size=0.1, bus_step_size=None,
#                                     link_car_flow_weight=link_car_flow_weight, link_truck_flow_weight=link_truck_flow_weight, link_passenger_flow_weight=link_passenger_flow_weight, link_bus_flow_weight=link_bus_flow_weight,
#                                     link_car_tt_weight=link_car_tt_weight, link_truck_tt_weight=link_truck_tt_weight, link_passenger_tt_weight=link_passenger_tt_weight, link_bus_tt_weight=link_bus_tt_weight,
#                                     max_epoch=max_epoch, algo="NAdam", l2_coeff=1e-4, fix_bus=True, column_generation=column_generation, use_tdsp=False,
#                                     use_file_as_init=os.path.join(data_folder, 'record', '49_iteration_estimate_path_flow.pickle'), 
#                                     save_folder=os.path.join(data_folder, 'record'), starting_epoch=50)                                   

# log_f_car_driving, log_f_truck_driving, log_f_passenger_bustransit, log_f_car_pnr, log_f_bus, \
#     f_car_driving, f_truck_driving, f_passenger_bustransit, f_car_pnr, f_bus, \
#     x_e_car, x_e_truck, x_e_passenger, x_e_bus, tt_e_car, tt_e_truck, tt_e_passenger, tt_e_bus, loss_list = \
#     dode.estimate_path_flow_pytorch(car_driving_scale=10, truck_driving_scale=2, passenger_bustransit_scale=2, car_pnr_scale=1, bus_scale=None,
#                                     car_driving_step_size=4, truck_driving_step_size=1.5, passenger_bustransit_step_size=3, car_pnr_step_size=1, bus_step_size=None,
#                                     link_car_flow_weight=link_car_flow_weight, link_truck_flow_weight=link_truck_flow_weight, link_passenger_flow_weight=link_passenger_flow_weight, link_bus_flow_weight=link_bus_flow_weight,
#                                     link_car_tt_weight=link_car_tt_weight, link_truck_tt_weight=link_truck_tt_weight, link_passenger_tt_weight=link_passenger_tt_weight, link_bus_tt_weight=link_bus_tt_weight,
...
#                                     car_driving_step_size=1, truck_driving_step_size=0.5, passenger_bustransit_step_size=1, car_pnr_step_size=1, bus_step_size=None,
#                                     link_car_flow_weight=link_car_flow_weight, link_truck_flow_weight=link_truck_flow_weight, link_passenger_flow_weight=link_passenger_flow_weight, link_bus_flow_weight=link_bus_flow_weight,
#                                     link_car_tt_weight=link_car_tt_weight, link_truck_tt_weight=link_truck_tt_weight, link_passenger_tt_weight=link_passenger_tt_weight, link_bus_tt_weight=link_bus_tt_weight,
#                                     max_epoch=max_epoch, algo="NAdam", l2_coeff=0, fix_bus=True, column_generation=column_generation, use_tdsp=True,
#                                     use_file_as_init=os.path.join(data_folder, 'record', '49_iteration_estimate_path_flow.pickle'), 
...
#              loss_list, config, data_dict], open(os.path.join(result_folder, 'final_use_16link_demand.pickle'), 'wb'))

pickle.dump([true_f_car_driving, true_f_truck_driving, true_f_passenger_bustransit, true_f_car_pnr, true_f_bus,
             f_car_driving, f_truck_driving, f_passenger_bustransit, f_car_pnr, f_bus,
             x_e_car, x_e_truck, x_e_passenger, x_e_bus, tt_e_car, tt_e_truck, tt_e_passenger, tt_e_bus,
             loss_list, config, data_dict], open(os.path.join(result_folder, 'final_use_16link_pathflow.pickle'), 'wb'))
