...
# %%
# nohup python 7link_dso.py > 7link_dso_output.log 2> 7link_dso_output.err &
# folder = '/home/qiling/Documents/MAC-POSTS/data/input_files_7link_dso'
# folder = '/home/qiling/Documents/MAC-POSTS/data/input_files_16link_dso'
folder = '/home/qiling/Documents/MAC-POSTS/data/input_files_PGH_dso'
...
# %%
dta = MNMAPI.dta_api()
dta.run_dso(max_iter, folder, verbose, with_dtc, method)
# %%
