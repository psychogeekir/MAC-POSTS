...
int main()
{
	...
	printf("BEGIN single class DTA test!\n");

	// std::string folder = "/home/alanpi/Desktop/MAC-POSTS/data/input_files_MckeesRocks_SPC";
	// std::string folder = "/home/lemma/Documents/MAC-POSTS/data/input_files_7link";
	std::string folder = "/media/lemma/WD/nhd/experiments/input_files/input_files_MckeesRocks_SPC_scenario_new";
