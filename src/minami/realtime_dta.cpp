...
/**************************************************************************
                          Screen shot
**************************************************************************/
MNM_Dta_Screenshot::MNM_Dta_Screenshot(const std::string& file_folder, MNM_ConfReader* config, PNEGraph graph, MNM_OD_Factory *od_factory)
{
  m_graph = graph;
  m_file_folder = file_folder;
  m_config = config;
...
MNM_Dta_Screenshot *make_screenshot(const std::string& file_folder, MNM_ConfReader* config, MNM_OD_Factory *od_factory,
                                    MNM_Link_Factory *link_factory, MNM_Node_Factory *node_factory, const PNEGraph& graph,
...
MNM_Dta_Screenshot *make_empty_screenshot(const std::string& file_folder, MNM_ConfReader* config,
